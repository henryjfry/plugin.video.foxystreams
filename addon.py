...
def authenticate(user_debrid):
    ...
    #xbmc.log(str(debrid_auth)+'===>PHIL', level=xbmc.LOGINFO)
...
def root(mode=None, scraper=None, query=None, season=None, episode=None,
    ...
    #xbmc.log(str(mdata)+'===>PHIL', level=xbmc.LOGINFO)
    try: kwargs['showname'] = mdata['info']['tvshowtitle']
    except: pass
    try: kwargs['title'] = mdata['info']['title']
    except: pass
    try: kwargs['year'] = mdata['info']['year']
    except: pass
    try: kwargs['name'] = mdata['info']['name']
    except: pass
    try: kwargs['mediatype'] = mdata['info']['mediatype']
    except: pass
    try: kwargs['episode'] = mdata['info']['episode']
    except: pass
    try: kwargs['season'] = mdata['info']['season']
    except: pass
...
#           xbmc.log(str(mdata)+'===>FOXY_STREAMs', level=xbmc.LOGNOTICE)
        ...
        xbmc.log(str('FOXY_LISTITEM')+'===>PHIL', level=xbmc.LOGINFO)
